      ...
      <div className="flex-col-reverse m-auto xl:flex xl:flex-row-reverse xl:w-2/3  ">        
        ...
        <div className="p-5 ">
          ...
          <p className="text-justify">
              ...
              Through mixing, recording and composing music I learned not to give up easily when faced with technical challenges and to communicate effectively.
              When working as a sound operator on a cruise ship through Norway I fell in love with the natural beauty of the country, 
              but decided to go back to Austria to take a position as a project manager for amusement park attractions.
